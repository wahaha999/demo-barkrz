...
class BirthWeightView extends Component {
    constructor(props) {
        super(props);
        this.state = {
            age: "",
    ...
    Next = () => {
        ...
        //     this.setState({ validationError: true, validationErrorMsg: "Please Input Correct Birth Year" });
        //     return;
        // }
...
export default connect(mapStateToProps, mapDispatchToProps)(BirthWeightView);
