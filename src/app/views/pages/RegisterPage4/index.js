...
class Register4Page extends Component {
  constructor(props) {
    super(props);
    this.state = {
      count: 2,
            ...
            <Col lg="4" className="mb-5 ml-auto mr-auto text-center">
              <div style={{ marginLeft: "20px", marginRight: "20px" }}>
                <div className="text-center">
                  ...
                  <p style={{ fontSize: "22px" }}>Owner Contact Information</p>
                </div>
                {owners}
              </div>
              <button
...
export default connect(mapStateToProps, mapDispatchToProps)(Register4Page);
